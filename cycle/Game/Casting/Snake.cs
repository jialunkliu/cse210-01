...
namespace Unit05.Game.Casting
{
    ...
    public class Snake : Actor
    {
        ...
        // In order to let the subclass "Snake2" adds segment to segments list
        public void AddToSegments(Actor segment)
        {
            segments.Add(segment);
        }

        public Actor GetLastsegment()
        {
            return segments.Last<Actor>();
        }
    }
